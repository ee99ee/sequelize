...
module.exports = (function() {
  ...
  */
  ...
  Model.prototype.__injectScope = function (options) {
    var scope = _.omit(this.__scope, 'include'); // Includes need special treatment

    _.defaults(options, scope);
    _.defaults(options.where, scope.where);

    if (this.__scope.include) {
      ...
      this.__scope.include.reverse().forEach(function (scopeInclude) {
